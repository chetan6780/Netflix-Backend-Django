...
class PlaylistModelTestCase(TestCase):
    ...
    def create_videos(self):
        ...
        video_b = Video.objects.create(title="My title", video_id="def123")
        video_c = Video.objects.create(title="My title", video_id="igk123")
    ...
    def setUp(self):
        ...
        obj_b = Playlist.objects.create(
            title='Test Title',  state=PublishStateOptions.PUBLISH, video=self.video_a)
    ...
    def test_video_playlist_ids_property(self):
        ...
        actual_ids = list(Playlist.objects.filter(
            video=self.video_a).values_list('id', flat=True))
    ...
    def test_created_count(self):
        qs = Playlist.objects.all()  # query_set
